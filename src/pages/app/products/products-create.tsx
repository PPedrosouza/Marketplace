...
export function ProductsCreate() {
    ...
    async function handleCreateProduct(data: EditForm) {
        try {
            ...
            <div className="flex flex-col justify-center">
                <div className="flex flex-col sm:flex-col lg:flex-row mt-8 mx-2 sm:mx-8 lg:mx-36 items-start sm:items-start lg:items-end max-w-10xl sm:h-auto lg:h-auto justify-between gap-4 sm:gap-2 lg:gap-2">
                    <div className="flex flex-col w-full h-auto sm:w-auto lg:w-auto lg:h-auto items-start gap-2">
                        ...
                        <span className="text-gray-500">Cadastre um produto para venda no marketplace</span>
                    </div>
                </div>

                <div className="flex flex-col sm:flex-col lg:flex-row mx-4 lg:mx-36 mt-10 mb-10 max-w-9xl gap-5">
                    <div className="flex flex-col sm:flex-row lg:flex-col w-full lg:w-[815px] h-60 lg:h-[340px] rounded-3xl bg-red-100 justify-center items-center">
                        <HugeiconsIcon icon={ImageUploadIcon} size={40} color="currentColor" className="text-orange-500" />
                        <p className="text-gray-500 text-sm text-center">Selecione a imagem do produto</p>
                    </div>
                    ...
                    <div className="flex flex-col w-full bg-white rounded-3xl p-6">
                        ...
                        <form className="flex flex-col gap-4 mt-6 w-full flex-1" onSubmit={handleSubmit(handleCreateProduct)}>
                            <div className="flex flex-col w-full lg:flex-row gap-4">
                                ...
                                <div className="w-full lg:w-1/4 flex flex-col gap-2">
                                    ...
                                    <div className="border-b flex items-center gap-2 transition-colors group">
                                        <InputGroup className="border-0 shadow-none ps-1 text-start break-words w-full max-w-full">
                                            <InputGroupAddon>
