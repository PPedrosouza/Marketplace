...
import { ArrowLeft02Icon, Cancel01Icon, Tick02Icon, UnavailableIcon, TagIcon } from '@hugeicons/core-free-icons';
        ...
        <>
            ...
            <div className="flex flex-col justify-center">
                <div className="flex flex-col sm:flex-row lg:flex-row mt-8 mx-4 sm:mx-8 lg:mx-36 items-start sm:items-center lg:items-center max-w-7xl sm:h-auto lg:h-20 justify-between gap-4 sm:gap-4 lg:gap-2">
                    <div className="flex flex-col w-full sm:w-auto lg:w-auto items-start gap-2">
                    ...
                    <div className="flex w-full sm:w-auto lg:w-auto flex-col sm:flex-row lg:flex-row gap-3 sm:gap-4 lg:gap-6">
                        <Link to="/products" className="text-orange-500 font-semibold flex gap-2">
                ...
                <div className="flex flex-col sm:flex-col lg:flex-row mx-4 sm:mx-8 lg:mx-36 mt-10 mb-10 max-w-7xl gap-5">
                    <div className="flex w-full sm:w-full lg:w-[415px] h-60 sm:h-64 lg:h-[340px] overflow-hidden rounded-3xl">
                    ...
                    <div className="flex flex-col w-full bg-white rounded-3xl p-6">
                        ...
                        <form className="flex flex-col gap-4 mt-6 w-full flex-1" onSubmit={handleSubmit(handleSignIn)}>
                            <div className="flex flex-col sm:flex-col lg:flex-row gap-4">
                                <div className="w-full sm:w-full lg:w-3/4 flex flex-col gap-2">
                                ...
                                <div className="w-full sm:w-full lg:w-1/4 flex flex-col gap-2">
                            ...
                            <div className="flex items-center border-b transition-colors">
                                <div className="relative w-full">
                                    ...
                                    <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                                        ...
                                        <SelectContent>
                                            <SelectGroup>
                                                <SelectItem value="all">Brinquedo</SelectItem>
                                                <SelectItem value="announced">Móvel</SelectItem>
                                                <SelectItem value="disabled">Papelaria</SelectItem>
                                                <SelectItem value="health-and-beauty">Saúde & Beleza</SelectItem>
                            ...
                            <div className="flex flex-col sm:flex-row lg:flex-row w-full gap-2 mt-auto pt-5 justify-center sm:justify-center lg:justify-end">
                                <Button disabled={isSubmitting} className="w-full sm:w-1/2 lg:w-1/2 border-orange-500 text-orange-500" type="button" variant={"outline"}>
                                    Cancelar
                                </Button>
                                <Button disabled={isSubmitting} className="w-full sm:w-1/2 lg:w-1/2 text-white" type="submit">
                                    Salvar e atualizar
                                </Button>
                            </div>
                        </form>
